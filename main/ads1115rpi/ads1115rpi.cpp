...
ADS1115settings::Input ADS1115rpi::getChannel(int channelNumber) {
        ADS1115settings::Input inputChannel = ADS1115settings::Input::AIN0;
        switch(channelNumber){
                case 0: inputChannel =  ADS1115settings::Input::AIN0;
                        break;
                case 1: inputChannel =  ADS1115settings::Input::AIN1;
                        break;
                case 2: inputChannel =  ADS1115settings::Input::AIN2;
                        break;
                case 3: inputChannel =  ADS1115settings::Input::AIN3;
                        break;
        }
